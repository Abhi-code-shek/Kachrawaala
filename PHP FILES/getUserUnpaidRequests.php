...
if ($conn->connect_error) {
	...
	$sql = "SELECT userrequest.reqId, userrequest.timeStamp, userrequest.timeSlot, userrequest.pincode, userrequest.address, services.serviceName, services.cost
			...
			where userrequest.userId = $userLoginId and userVer = 0 and staffId IS NOT NULL and userrequest.serviceId = services.serviceId order by userrequest.timeStamp;";
